...
# https://github.com/python-unsam/Programacion_en_Python_UNSAM/blob/master/Notas/01_Introduccion/05_Listas.md
...
# >>>
# 
# Probá tu código con 'Los hermanos sean unidos porque ésa es la ley primera', '¿cómo transmitir a los otros el infinito Aleph?' 
# y 'Todos, tu también'. ¿Qué falla en esta última? (¡no hace falta que lo resuelvas!)
